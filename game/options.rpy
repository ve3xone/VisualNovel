...
define config.name = _("Дивный новый мир: спасение будущего")
...
## Режим разработчика (Выключен по умолчанию)
...
define gui.about = _p("Новелла подробно рассказывает о профессии искусственного интеллекта-специалиста, описывая его обязанности, навыки, вызовы и перспективы в данной области.")
...
define build.name = "BraveNewWorld"
...
#Громкость не задать так что у кого громко сорян
#Но я сделал это локально вот так "E:\Apps\renpy-8.1.3-sdk\renpy\common\00start.rpy":
#246 строка
###########
#    if config.main_menu_music:
#        $ renpy.music.play(config.main_menu_music, if_changed=True, fadein=config.main_menu_music_fadein, relative_volume=0.03)
#    else:
#        $ renpy.music.stop()
###########

define config.main_menu_music = "lyrics_7dl.ogg"
...
define config.save_directory = "Brave_new_world-1699533771"
