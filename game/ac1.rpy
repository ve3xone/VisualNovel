label ac1:
    ...
    #blur 8 {image=text_blur_8.png}
    #И мы просидели так всю ночь
    unknown "{image=text_blur_8.png}" 

    "Обнаружен новый модуль. Настройка конфигурации системы."

    #blur 6 {image=text_blur_6.png}
    #Да, не хорошо сбивать режим сна...
    unknown "{image=text_blur_6.png}"

    "Слуховой модуль подключён."

    #blur 4 {image=text_blur_4.png}
    #Антон.
    unknown "{image=text_blur_4.png}"

    "Распознание речи. Женский голос."

    #blur 3 {image=text_blur_3.png}
    #Антон!
    unknown "{image=text_blur_3.png}"

    "Агрессивный тон. Возможна угроза. Подготовить..."

    #blur 2 {image=text_blur_2.png}
    #Антон!
    unknown "{image=text_blur_2.png}"
